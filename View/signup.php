...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    include '../config/connection.php'; // Assuming $conn is defined here
...
<div class="container">
    ...
    <form action="/login project/signup.php" method="post">
        ...
        <div class="mb-3">
            ...
            <div id="link" style="color:while; font-size: 18px"><a href="../index.php" >Already have an account! Click here to login</a></div>
        </div>
