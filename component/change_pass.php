<?php
require '/Login Project/config/connection.php';
include '/Login Project/component/_navbar.php';
$error="";
$success="";
if (isset($_GET['token'])) {
  $token = $_GET['token'];
  ...
  if (isset($_POST['token']) && $_POST['token'] === $token && empty($error)) {
      ...
      if (empty($new_password) || empty($confirm_password)) {
          ...
          if ($update_password_query) {
              $success = "Your password has been successfully reset. You can now <a href='/Login Project/index.php'>log in</a>.";
          } else {
